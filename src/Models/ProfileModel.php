...
class ProfileModel extends AbstractModel implements HasIdInterface
{
    ...
    #[Pure] #[ArrayShape(['ID' => "int", 'ADMIN' => "int", 'NAME' => "string", 'LAST_NAME' => "string", 'PERSONAL_GENDER' => "string", 'PERSONAL_PHOTO' => "string", 'TIME_ZONE' => "string", 'TIME_ZONE_OFFSET' => "int"])] public function toArray(): array
    {
        return [
            'ID' => $this->getId(),
            'ADMIN' => $this->getAdmin(),
