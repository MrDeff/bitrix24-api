...
class Credential
{
     ...
     * @return self
     */
    #[Pure] public static function initFromArray(array $request): self
    {
        return new self(
            (string)$request['access_token'],
            (int)$request['expires'],
            (string)$request['domain'],
            (string)$request['server_endpoint'],
    ...
    #[ArrayShape(['access_token' => "string", 'expires' => "int", 'domain' => "string", 'server_endpoint' => "string", 'client_endpoint' => "string", 'member_id' => "string", 'user_id' => "int", 'refresh_token' => "string", 'status' => "string"])] public function toArray(): array
    {
        return [
